...
SabertoothPropulsion::SabertoothPropulsion(ros::NodeHandle node_handle, ros::NodeHandle private_node_handle)
{
	...
	//Get publishers
	left_feedback_publisher_ = node_handle.advertise<std_msgs::Int16>("feedback/left_topic", 1, true);
	right_feedback_publisher_ = node_handle.advertise<std_msgs::Int16>("feedback/right_topic", 1, true);
